...
# --- 配置 (美西版) ---
CITY_CONFIG = {
    "Vancouver": {"coords": (49.2827, -123.1207), "tz": "America/Vancouver"},
    "Seattle": {"coords": (47.6062, -122.3321), "tz": "America/Los_Angeles"}
}
...
def get_city_data(city_name, lat, lon):
    ...
    try:
        ...
        if not store_ids: return [], slot, local_day
...
if __name__ == "__main__":
    ...
    for i, city in enumerate(cities):
        ...
        if i < len(cities) - 1: time.sleep(random.uniform(20, 40))
